...
class FrozenLake:
    ...
    def step(self, a):
        ...
        if self.n == 4:
            ...
            if self.state == 19 or self.state == 29 or self.state == 35 or self.state == 41 or self.state == 42 or self.state == 46 or self.state == 49 or self.state == 52 or self.state == 54 or self.state == 59:
                reward = -30
                done = True
            elif self.state == 63:
                reward = 30
